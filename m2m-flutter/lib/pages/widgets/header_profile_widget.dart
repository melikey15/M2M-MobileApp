...
class HeaderProfileWidget extends StatefulWidget {
  ...
  const HeaderProfileWidget(this._height, this._showIcon, this._icon,
      {Key? key})
      : super(key: key);

  @override
  _HeaderProfileWidgetState createState() =>
      _HeaderProfileWidgetState(_height, _showIcon, _icon);
}
...
class _HeaderProfileWidgetState extends State<HeaderProfileWidget> {
  ...
  _HeaderProfileWidgetState(this._height, this._showIcon, this._icon);
